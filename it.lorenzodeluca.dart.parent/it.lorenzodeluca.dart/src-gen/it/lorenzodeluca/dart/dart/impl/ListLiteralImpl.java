 ...
 * </p>
 * <ul>
 *   <li>{@link it.lorenzodeluca.dart.dart.impl.ListLiteralImpl#isIsConst <em>Is Const</em>}</li>
 *   <li>{@link it.lorenzodeluca.dart.dart.impl.ListLiteralImpl#getTypeArguments <em>Type Arguments</em>}</li>
 *   <li>{@link it.lorenzodeluca.dart.dart.impl.ListLiteralImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListLiteralImpl extends ExpressionImpl implements ListLiteral
{
  ...
  public void setIsConst(boolean newIsConst)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DartPackage.LIST_LITERAL__IS_CONST, oldIsConst, isConst));
  }
  ...
  public NotificationChain basicSetTypeArguments(TypeArguments newTypeArguments, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DartPackage.LIST_LITERAL__TYPE_ARGUMENTS, oldTypeArguments, newTypeArguments);
  ...
  public void setTypeArguments(TypeArguments newTypeArguments)
  {
    if (newTypeArguments != typeArguments)
    {
      ...
      if (typeArguments != null)
        msgs = ((InternalEObject)typeArguments).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DartPackage.LIST_LITERAL__TYPE_ARGUMENTS, null, msgs);
      if (newTypeArguments != null)
        msgs = ((InternalEObject)newTypeArguments).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DartPackage.LIST_LITERAL__TYPE_ARGUMENTS, null, msgs);
      msgs = basicSetTypeArguments(newTypeArguments, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DartPackage.LIST_LITERAL__TYPE_ARGUMENTS, newTypeArguments, newTypeArguments));
  }
  ...
  public EList<Expression> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Expression>(Expression.class, this, DartPackage.LIST_LITERAL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DartPackage.LIST_LITERAL__TYPE_ARGUMENTS:
        return basicSetTypeArguments(null, msgs);
      case DartPackage.LIST_LITERAL__ELEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DartPackage.LIST_LITERAL__IS_CONST:
        return isIsConst();
      case DartPackage.LIST_LITERAL__TYPE_ARGUMENTS:
