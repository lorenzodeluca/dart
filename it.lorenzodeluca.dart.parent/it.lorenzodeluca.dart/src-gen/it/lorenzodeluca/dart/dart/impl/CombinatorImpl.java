 ...
 * </p>
 * <ul>
 *   <li>{@link it.lorenzodeluca.dart.dart.impl.CombinatorImpl#getIdentifiers <em>Identifiers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CombinatorImpl extends MinimalEObjectImpl.Container implements Combinator
{
  ...
  public EList<String> getIdentifiers()
  {
    if (identifiers == null)
    {
      identifiers = new EDataTypeEList<String>(String.class, this, DartPackage.COMBINATOR__IDENTIFIERS);
    }
    return identifiers;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DartPackage.COMBINATOR__IDENTIFIERS:
