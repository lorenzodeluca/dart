 ...
 * </p>
 * <ul>
 *   <li>{@link it.lorenzodeluca.dart.dart.impl.BooleanLiteralImpl#getBoolValue <em>Bool Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanLiteralImpl extends ExpressionImpl implements BooleanLiteral
{
  ...
  public void setBoolValue(String newBoolValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DartPackage.BOOLEAN_LITERAL__BOOL_VALUE, oldBoolValue, boolValue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DartPackage.BOOLEAN_LITERAL__BOOL_VALUE:
        return getBoolValue();
    }
